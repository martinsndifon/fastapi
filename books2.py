...
BOOKS = [
    Book(1, "Computer Science Pro", "Martins", "A very nice book", 5, 2030),
    Book(2, "Be Fase with FastAPI", "Martins", "A great book", 5, 2030),
    Book(3, "Computer Science Pro", "Martins", "A very nice book", 5, 2029),
...
@app.get("/books/", status_code=status.HTTP_200_OK)
async def read_books_by_rating(book_rating: int = Query(gt=0, lt=0)):
    """Return books that are equal to rating"""
    books_to_return = []
    for book in BOOKS:
